  ...
  <div class="container" data-aos="fade-up">
        <div class="container-fluid">
           <div class="mb-0">
             ...
             <div class="mb-3">
               <label for="" class="form-label"></label>
               <textarea class="form-control" id="deskripsi" placeholder="deskripsi" name="deskripsi" rows="12">
               </textarea>
             </div>
...
<section id="blog" class="blog">
  ...
  <div class="col-sm-3 mt-4">
    <div class="card">
      <img src="{{asset('storage/public/postfoto/'.$item->foto)}}" class="img-fluid">
      <div class="card-body">
       ...
       <div class="dropdown p-3">
        <button class="btn btn-success dropdown-toggle" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
         ...
         <li><a class="dropdown-item" href="editpost/{{$item->id}}/edit">Edit Data</a></li>
         <li><form action="blog/{{$item->id}}" method="POST">
            @csrf
            @method('DELETE')
